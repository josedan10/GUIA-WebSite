...
<body>
	...
	<nav class="nav2" id="nav-movil">
		...
		<div id="menu" class="menu">
			...
			<div class="grupo">
				<div><a href="index.php"><span class="icon icon-open-book"></span>SIRIUS</a></div>
		...
		<div class="blog" id="blog">
			...
			<article>
				...
				<div class="atributos-articulo">
					...
					<span class="icon icon-typing"></span>0 Comentarios
				...
				<button type="button" class="btn"><a href="articulo1/article.html">LEER MÁS</a></button>
			</article>
			<article>
				<h2>Titulo del artículo</h2>
				<div class="atributos-articulo">
