<?php 
	...
	<body>
		<div class="mail" style="width: 90%;
				margin: 0 auto;
				background: #2B0C47;
				color: #F5F5F5;
	">
			<h1 style=\'font:  bold 30px "Roboto", "Arial", sans-serif;
				text-align: center;
				display: block;
				margin: 0 auto;
				width: 100%;\'>¡SUSCRIPCIÓN EXITOSA!</h1>

			<p style=\'width: 100%;
				font: normal 14px "Roboto","Arial", sans-serif;
				padding: 50px;
				box-sizing: border-box;
				text-align: center;\'>Gracias por suscribirte a nuestro blog. Ahora podrás estar al día con nuestras actividades y publicaciones</p>
			...
			<h2 style=\'font: bold 22px "Roboto", "Arial", sans-serif;
				width: 100%;
				display: block;
				text-align: center;\' ><b>¡Cielos claros!</b></h2>
		</div>
	</body>
	</html>
	';
